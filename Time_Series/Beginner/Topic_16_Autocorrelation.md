...
**Neighbouring months are close.** Ashfell Police Department, 2023:
...
![Three panels. The left panel shows Ashfell's 2023 line with each step between neighbouring months highlighted. The middle panel is a scatter plot with each month's count on the horizontal axis and the following month's count on the vertical axis, for Ashfell, where the dots rise together in a band. The right panel is the same scatter for Orrindale, where the dots form a shapeless cloud](Figures/fig_16_autocorrelation.png)
...
For **Ashfell**, the dots rise together. A month around 60 is followed by a month around 60 to 90. A month around 150 is followed by a month around 120 to 160. Knowing where you are on the bottom axis narrows down where you will land on the side axis. That is memory.

For **Orrindale**, the eight officer department, the same picture is a shapeless cloud. Knowing this month was 2 tells you essentially nothing about next month.
...
<details>
<summary><b>1.</b> Ashfell's neighbouring months are 24 apart on average and any two months of the year are 38 apart. Why does that difference demonstrate memory?</summary>
...
<details>
<summary><b>2.</b> Orrindale's scatter is a cloud. Does that mean Orrindale is more volatile than Ashfell in a way that should concern anyone?</summary>

No. It means Orrindale's counts are so small that randomness swamps everything else. Ashfell's 100 incidents a month reflect conditions across a large department; Orrindale's 0 or 2 reflect whether a handful of events happened to fall inside a particular month. The cloud is a statement about sample size, not about how the department operates.
</details>
