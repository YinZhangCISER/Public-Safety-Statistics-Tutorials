...
To tell the left pattern from the right one you would need to watch Ashfell until roughly 2040.
...
- **Seasonality and a trend coexist happily.** Ashfell has both at once. Every July is above its neighbours, and every July is lower than the July before it. Neither cancels the other.
...
<details>
<summary><b>1.</b> Ashfell's July counts run 167, 132, 120, 156, 157, 109, 141 across seven years. Is the up and down movement in those numbers a cycle?</summary>
