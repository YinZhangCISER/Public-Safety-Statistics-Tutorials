...
| [Intermediate](Intermediate/) | 16 | Some background, wants to do it | Jupyter notebooks, gentle | **Complete** |
| [Advanced](Advanced/) | 16 | Fits models and reports results | Jupyter notebooks, complete | **12 of 16 published** |
